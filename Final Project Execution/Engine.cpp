...
//        res = arr;
  ...
  */
  ...
  string Engine::showCell(int w) {
    ...
    switch (t) {
      case V:
		  sprintf(buff, "v:%d", val);
		  s = buff;
        //s = "v:" + val;
      break;
      case U:
		  sprintf(buff, "u:%d", val);
		  s = buff;
		  //s = "u:" + val;
      break;
      case N:
		  sprintf(buff, "n:%d", val);
		  s = buff;
		 // s = "n:" + val;
      break;
      case C:
      ...
      break;
      case R:
		  sprintf(buff, "r:%d", val);
		  s = buff;
		  //s = "r:" + val;
      break;
      case A:
		  sprintf(buff, "a:%d", val);
		  s = buff;
		  //s = "a:" + val;
      break;
      default:
